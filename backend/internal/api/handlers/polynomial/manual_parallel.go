...
func manualParallel(c *gin.Context, matrices, identityMatrix [][]float64, coefficients []float64, workerClient proto.WorkerServiceClient, client *entity.WorkersClient) error {
